      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-2 gap-6 max-w-7xl mx-auto px-2">
          {educationData.map((edu, index) => (
            <Card
              key={index}
              className="group relative overflow-hidden border-primary/20 bg-card/50 backdrop-blur-sm hover:border-primary/40 transition-all duration-300 hover:shadow-[0_0_30px_rgba(147,51,234,0.2)] animate-fade-out"
