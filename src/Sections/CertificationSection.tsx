...
const Certificates = () => {
    return (
        <section id="certificates" className="py-16 px-4 sm:px-6 lg:px-8 bg-secondary/20">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12 animate-fade-in">
                    ...
                    <p className="text-muted-foreground max-w-2xl mx-auto">
                        Continuously learning and expanding my expertise through industry-recognized certifications
                    </p>
                </div>
                        ...
                        >
                            ...
                            <CardContent className="space-y-3 pt-0">
                                <div className="flex items-center gap-2">
                                    <Badge variant="secondary" className="text-xs bg-secondary/50 hover:bg-secondary/80 transition-colors">
