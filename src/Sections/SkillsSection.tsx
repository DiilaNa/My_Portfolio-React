...
const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Mongoose", icon: SiMongoose, color: "#4169E1", level: 80 },
      { name: "MongoDB", icon: SiMongodb, color: "#47A248", level: 75 },
      { name: "Git", icon: SiGit, color: "#F05032", level: 90 },
      { name: "GitHub", icon: SiGithub, color: "#f9f9f9ff", level: 88 },
      { name: "Vercel", icon: SiVercel, color: "#2496ED", level: 70 },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: "Pandas", icon: SiPandas, color: "#4721e3ff", level: 65 },
      { name: "NumPy", icon: SiNumpy, color: "#94d9efff", level: 60 },
      { name: "ScikitLearn", icon: SiScikitlearn, color: "#FF6F00", level: 50 },
      {
        name: "Matplotlib",
                        ...
                        return (
                          ...
                          >
                            <div className="relative">
                              ...
                              />
                              <div
                                className="absolute inset-0 blur-xl opacity-0 group-hover/skill:opacity-50 transition-opacity duration-300"
                            ...
                            <div className="w-full h-1.5 bg-secondary/50 rounded-full overflow-hidden mt-1">
                              <div
                                className="h-full bg-gradient-to-r from-primary to-accent transition-all duration-500 group-hover/skill:shadow-[0_0_8px_rgba(124,58,237,0.4)]"
                                style={{
                                  width: `${skill.level}%`,
                                  transitionDelay: `${
                                    categoryIndex * 0.1 + skillIndex * 0.05
